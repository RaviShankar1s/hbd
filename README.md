# Birthday Surprise Websites  🎂🎉

This is a special **Birthday Celebration ravWebsite** created using **Next.js, Tailwind CSS, Framer Motion**, and **Lucide Icons**.  
It's designed as a personal and emotional way to wish someone special — when you can't be there physically, let your code speak! and its special for used for birthday surprise 💖
